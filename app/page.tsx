...
export default function Home() {
  return (
    <>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <h1 className="hero-title mb-4">
                <span className="text-primary-yellow">Free</span> All-in-One <br />
                <span className="text-primary-yellow">Client-Side</span> PDF Editor
              </h1>
              <p className="hero-description mb-5">
                StitchPDF is a completely <strong>free PDF tool</strong> that runs{" "}
                <strong>100% in your browser</strong>. No server uploads, all processing
                happens on your device using <strong>client-side rendering</strong>. Your
                privacy is protected, free forever, no watermarks, and works offline!
              </p>

              {/* Hero Illustration */}
              <div className="hero-illustration mb-5">
                <Image
              ...
              <a href="#features" className="btn btn-primary btn-lg me-3 mb-3">
                Get Started
              </a>
      ...
      <section
        id="features"
        className="features-section bg-white"
        style={{
          minHeight: "100vh",
          display: "flex",
          alignItems: "center",
      ...
      >
        <Container>
          <h2 className="text-center mb-3">Most Popular PDF Tools</h2>
          <p className="text-center text-muted mb-4">
            Manage your PDF documents easily with various tools available
          </p>
