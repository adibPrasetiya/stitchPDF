...
export default function AddTextPage() {
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      ...
      if (
        ...
        !bgColorDropdownRef.current.contains(event.target as Node)
      ) {
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    if (draggingTextBox) {
      ...
      setTextBoxes(
        textBoxes.map((textBox) =>
          textBox.id === draggingTextBox ? { ...textBox, x, y } : textBox
        )
      );
    }
  };
  ...
  const updateSelectedTextBox = (updates: Partial<TextBox>) => {
    ...
    setTextBoxes(
      textBoxes.map((textBox) =>
        textBox.id === selectedTextBox ? { ...textBox, ...updates } : textBox
      )
    );
  };
    ...
    try {
      ...
      const fonts = {
        Helvetica: {
          ...
          boldItalic: await pdfDocument.embedFont(
      ...
      const getFont = (family: string, bold: boolean, italic: boolean) => {
        const fontFamily =
          fonts[family as keyof typeof fonts] || fonts.Helvetica;
      ...
      textBoxes.forEach((textBox) => {
        ...
        const pdfY =
          pageHeight - textBox.y / canvasScale - textBox.height / canvasScale;
      ...
      setMessage(
        `Success! PDF with ${textBoxes.length} text box(es) has been downloaded.`
      );
      ...
      console.error(error);
      setMessage(
        error instanceof Error ? error.message : "Error applying text to PDF."
      );
      setMessageType("danger");
    } finally {
      setLoading(false);
      ...
      <Container>
        {!showPreview && (
          <FeatureTitle
            ...
            description="Add customizable text boxes to your PDF documents with formatting options"
          />
        )}
                  ...
                  >
                    ...
                    <div className="d-flex align-items-center justify-content-between flex-wrap gap-2">
                      <div className="d-flex align-items-center gap-2">
                        ...
                        <button
                          onClick={() =>
                            updateSelectedTextBox({ bold: !selectedBox.bold })
                          }
                          title="Bold"
                          style={{
                            width: "28px",
                        ...
                        <button
                          onClick={() =>
                            updateSelectedTextBox({
                              underline: !selectedBox.underline,
                            })
                          }
                          title="Underline"
                          style={{
                            ...
                            border: "1px solid #adadad",
                            borderRadius: "3px",
                            background: selectedBox.underline
                              ? "#ffc107"
                              : "white",
                            cursor: "pointer",
                            display: "flex",
                                ...
                                {[
                                  ...
                                  <button
                                    ...
                                    style={{
                                      ...
                                      background: color,
                                      border:
                                        selectedBox.textColor.toLowerCase() ===
                                        color
                                          ? "2px solid #ffc107"
                                          : "1px solid #ccc",
                                      cursor: "pointer",
                          ...
                          >
                            ...
                            <div
                              style={{
                                ...
                                height: "3px",
                                background:
                                  selectedBox.backgroundOpacity > 0
                                ...
                                {[
                                  ...
                                  <button
                                    ...
                                    style={{
                                      ...
                                      background: color,
                                      border:
                                        selectedBox.backgroundColor.toLowerCase() ===
                                          color &&
                                        selectedBox.backgroundOpacity > 0
                                          ? "2px solid #ffc107"
                                          : "1px solid #ccc",
                ...
                >
                  <div className="row align-items-center g-3">
                    <div className="col-md-6">
                      ...
                      >
                        {
                          textBoxes.filter((t) => t.pageIndex === currentPage)
                            .length
                        }
                      </div>
                      <small className="text-muted">
                        Click to add • Drag to move • Resize from corner
                      </small>
                    </div>
                    <div className="col-md-6">
                      {textBoxes.length > 0 && (
                  ...
                  {textBoxes
                    ...
                    .map((textBox) => (
                      <div
                        ...
                        onDoubleClick={(e) =>
                          handleTextBoxDoubleClick(e, textBox.id)
                        }
                        style={{
                          position: "absolute",
                          left: `${textBox.x}px`,
                      ...
                      >
                        ...
                        <div
                          style={{
                            ...
                            textDecoration: textBox.underline
                              ? "underline"
                              : "none",
                            wordWrap: "break-word",
                          }}
                        >
                          {editingTextBox === textBox.id ? (
                            <input
                              ...
                              value={textBox.text}
                              onChange={(e) =>
                                updateSelectedTextBox({ text: e.target.value })
                              }
