...
export default function StampPage() {
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    if (resizingStamp) {
      ...
      setStampPositions(stampPositions.map(stamp =>
  ...
  const handleApplyStamps = async () => {
    ...
    try {
      ...
      try {
        ...
        console.error('PNG conversion failed, trying direct embed:', _embedError);
        // Fallback: try direct embed
        const imageBytes = await stampImage.arrayBuffer();
        const isPng = stampImage.type === 'image/png' || stampImage.name.toLowerCase().endsWith('.png');
      ...
      stampPositions.forEach((stamp) => {
        ...
        const pdfY = pageHeight - (stamp.y / canvasScale) - (stamp.height / canvasScale);
      ...
      const arrayBuffer = stampedPdfBytes.buffer.slice(stampedPdfBytes.byteOffset, stampedPdfBytes.byteOffset + stampedPdfBytes.byteLength) as ArrayBuffer;
      ...
      setMessage(`Success! PDF with ${stampPositions.length} stamp(s) has been downloaded.`);
      ...
      console.error(error);
      setMessage(error instanceof Error ? error.message : 'Error applying stamps to PDF.');
      setMessageType('danger');
    } finally {
      setLoading(false);
    }
      ...
      <section className="page-header">
        <Container>
          <div className="text-center">
            <h1 className="mb-3">Add Stamp to PDF</h1>
            <p className="lead text-muted">
              Upload a PDF and image, then click to place stamps anywhere on your document
            </p>
          </div>
        </Container>
      </section>
              ...
              <div className="feature-card">
                ...
                <div className="row g-3 mb-4">
                      ...
                      {!pdfFile ? (
                        <>
                          ...
                          <input
                            ...
                            id="pdf-input"
                          />
                          <label htmlFor="pdf-input" className="btn btn-primary btn-sm mt-2">
                            Choose PDF
                          </label>
                        </>
                      ) : (
                        <div className="uploaded-file-display">
                          ...
                          <h6 className="mb-2 text-success">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" style={{ marginRight: '6px', verticalAlign: 'middle' }}>
                  ...
                  <div className="col-md-6">
                    ...
                    <div className={`pdf-upload-zone ${stampImage ? 'file-uploaded' : ''}`}>
                      {!stampImage ? (
                        <>
                          <div className="upload-icon mb-2">
                            <svg width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                          ...
                          <input
                            ...
                            id="stamp-input"
                          />
                          <label htmlFor="stamp-input" className="btn btn-primary btn-sm mt-2">
                            Choose Image
                          </label>
                        </>
                      ) : (
                        <div className="uploaded-file-display">
                          ...
                          <div className="file-info mb-2">
                            <div className="fw-bold text-truncate" style={{ fontSize: '13px' }}>{stampImage.name}</div>
                          </div>
                          <button
                            className="btn btn-outline-danger btn-sm"
                            onClick={() => {
                  ...
                  <div className="row align-items-center g-3">
                    <div className="col-md-6">
                      ...
                      <div className="fw-bold" style={{ fontSize: '24px', color: 'var(--primary-yellow-dark)' }}>
                        {stampPositions.filter(s => s.pageIndex === currentPage).length}
                      </div>
                      <small className="text-muted">Drag corner to resize • Drag stamp to move</small>
                    </div>
                    <div className="col-md-6">
                      {stampPositions.length > 0 && (
                        <Button onClick={handleApplyStamps} disabled={loading} fullWidth>
                    ...
                    .map((stamp) => (
                      <div
                        ...
                        style={{
                          ...
                          border: (draggingStamp === stamp.id || resizingStamp === stamp.id) ? '2px solid var(--primary-yellow)' : '2px dashed var(--primary-yellow)',
                          borderRadius: '4px',
                          cursor: draggingStamp === stamp.id ? 'grabbing' : 'move',
                          transition: (draggingStamp === stamp.id || resizingStamp === stamp.id) ? 'none' : 'all 0.2s ease',
                          boxShadow: (draggingStamp === stamp.id || resizingStamp === stamp.id) ? '0 6px 16px rgba(255, 193, 7, 0.5)' : 'none',
                          zIndex: (draggingStamp === stamp.id || resizingStamp === stamp.id) ? 1000 : 1,
                        }}
                      >
                ...
                {totalPages > 1 && (
                  <div className="d-flex justify-content-center align-items-center mt-4 gap-3">
                    <button
                      ...
                      onMouseEnter={(e) => {
                        if (currentPage !== 0) {
                          e.currentTarget.style.backgroundColor = 'var(--primary-yellow-light)';
                      ...
                      onMouseLeave={(e) => {
                        e.currentTarget.style.backgroundColor = currentPage === 0 ? '#e9ecef' : 'white';
                        e.currentTarget.style.borderColor = 'var(--primary-yellow-light)';
                    ...
                    <button
                      ...
                      onMouseLeave={(e) => {
                        e.currentTarget.style.backgroundColor = currentPage === totalPages - 1 ? '#e9ecef' : 'white';
                        e.currentTarget.style.borderColor = 'var(--primary-yellow-light)';
                        e.currentTarget.style.transform = 'translateY(0)';
                        e.currentTarget.style.boxShadow = 'none';
                      }}
            ...
            {!showPreview && (
              <div className="how-to-use-card">
                <div className="how-to-use-header">
                  ...
                  <h3 className="how-to-use-title">How to Add Stamp</h3>
                </div>
                  ...
                  <li className="how-to-step">
                    <div className="how-to-step-content">
                      ...
                      <p className="how-to-step-description">
                        Select the PDF file you want to stamp or watermark
                      </p>
                    </div>
                  </li>
                  <li className="how-to-step">
                    <div className="how-to-step-content">
                      <p className="how-to-step-text">Upload stamp image</p>
                      <p className="how-to-step-description">
                        Choose an image (PNG, JPG) to use as stamp
                      </p>
                    </div>
                  </li>
                  <li className="how-to-step">
                    <div className="how-to-step-content">
                      <p className="how-to-step-text">Click on PDF to place stamp</p>
                      <p className="how-to-step-description">
                        Adjust stamp size, then click at the desired position on the PDF page
                      </p>
                    </div>
                  </li>
                  <li className="how-to-step">
                    <div className="how-to-step-content">
                      ...
                      <p className="how-to-step-description">
                        Click &quot;Apply Stamps&quot; to save the PDF with the added stamps
                      </p>
                    </div>
                  </li>
                </ol>
                ...
                <div className="how-to-examples">
                  ...
                  <div className="how-to-example-item">
                    ...
                    <span>Use PNG/JPG/JPEG images - PNG with transparent background for best results</span>
                  </div>
                  <div className="how-to-example-item">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" strokeWidth="2">
                      <polyline points="20 6 9 17 4 12" />
                    </svg>
                    <span>Drag stamp to move, drag yellow corner to resize (aspect ratio maintained)</span>
                  </div>
                  <div className="how-to-example-item">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" strokeWidth="2">
                      <polyline points="20 6 9 17 4 12" />
                    </svg>
                    <span>Click the red × button to remove stamp, add stamps on multiple pages</span>
                  </div>
                </div>
              </div>
            )}
